...
public class RevThumbnailGeneratorHelperModule {

    public void revCreateVideoThumbnail(ReactApplicationContext reactContext, ReadableMap options, Promise promise) {
    ...
    private static class ProcessDataTask extends GuardedResultAsyncTask<ReadableMap> {
        ...
        protected ReadableMap doInBackgroundGuarded() {
            ...
            String thumbnailDir = "/storage/emulated/0/Documents/Owki/rev_media/thumbnails";
